...
void showTwoLists(List<DataType> list1, List<DataType> list2); 	// Displays two lists that are supposedly equivalent.
...
template <typename DataType>
void showTwoLists(List<DataType> list1, List<DataType> list2) {
